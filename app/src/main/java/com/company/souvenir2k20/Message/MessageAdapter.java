...
public class MessageAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mViewHolder.userImage = (ImageView) convertView.findViewById(R.id.ivMessageUser);
            mViewHolder.messageHeading = (TextView) convertView.findViewById(R.id.tvMessageHeading);
            mViewHolder.messageName = (TextView) convertView.findViewById(R.id.tvMessageName);
            mViewHolder.messagePost = (TextView) convertView.findViewById(R.id.tvMessagePost);
